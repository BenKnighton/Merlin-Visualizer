...
class Terrain(QtGui.QMainWindow):
    def __init__(self):
        ...
        self.window.setWindowTitle("M.E.R.L.I.N")
        ...
        self.mesh1 = gl.GLMeshItem(
            ...
            drawEdges=True,
            smooth=True,
            edgeColor=(0.7725,0.8275,0.8824,1),
            drawFaces=False,
            # computeNormals=True,
        )
        ...
        distance = 50
        #Image
        image = Image.open('Picture 7.png')
        data = np.array(image)
        ...
        gm = gl.GLTextItem(text="MERLIN", color=(197, 211, 225))
        gm.setData(font= QtGui.QFont("OCR A Extended", 20))
        gm.translate(0, ((x)/2), -(180+distance))
        self.window.addItem(gm)

        #Text 2
        gm = gl.GLTextItem(text="Mind • Emulating • Replication • Logic • Incorperating • Neural-Networks", color=(197, 211, 225))
        gm.setData(font= QtGui.QFont("OCR A Extended", 9))
        gm.translate((y)/2, 0, -(180+distance))
        self.window.addItem(gm)
